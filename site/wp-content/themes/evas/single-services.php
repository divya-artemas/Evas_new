...
<?php  if (get_the_ID() == 424){ ?>
  ...
  <div class="icv-block">
      ...
      <?php $icv_background_image = get_field('icv_background_image'); ?>
      <div class="full-width" style="background: url(<?php echo $icv_background_image['sizes']['banner-img'];?>) no-repeat center center/cover;">
        <div class="container">
      ...
      <div class="service-list">
        <div class="service-set flex">
          <div class="service-flex white-trans" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
            <h3>Other Services<?php //echo get_field('service_heading',8);?></h3>
          </div>
          <?php
                $i=1;                  
