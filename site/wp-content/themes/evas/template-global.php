...
?>
    ...
    <div class="banner" style="background:linear-gradient(270deg, rgba(41,82,143,0.07326680672268904) 0%, rgba(41,82,143,0.7931547619047619) 60%, rgba(41,82,143,0.9220063025210083) 70%, rgba(41,82,143,1) 100%), url(<?php echo $image_data[0];?>) no-repeat center center/cover;">
      ...
      <div class="icv-block">
        <div class="container">
          <div class="flex">
            ...
            <div class="full-size-content" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
            <?php echo get_field('l_content');?>
            </div>
          </div>
        </div>
      </div>
      <?php $ab_img = get_field('ab_background_image'); ?>
      <div class="full-width" style="background: url(<?php echo $ab_img['sizes']['banner-img'];?>) no-repeat center center/cover;">
        <div class="container">
     ...
     <div class="different-locations">
		 <div class="container">
			 <h3>
				 <?php echo get_field('loc_heading');?>   
			 </h3>
			<?php echo get_field('locations_list');?>   
		 </div>
     </div>
